...
const ConstructionMenu: React.FC = () => {
  ...
  // Moved useEffect before early return to comply with React Rules of Hooks
  useEffect(() => {
  ...
  return (
    ...
    <div className="absolute bottom-0 left-0 w-full z-30 flex flex-col justify-end pointer-events-none">
      ...
      {/* 1. Slide-Up Panel (Buildings List) */}
      <div 
                        ...
                        >
                            ...
                            <div className="p-2.5 pointer-events-none">
                                ...
                                <div className="flex justify-between items-center text-[10px]">
                                    {/* Population REMOVED from build card preview as requested */}
      ...
      {/* 2. Dock Icons - Reduced movement distance */}
