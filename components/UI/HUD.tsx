    ...
    <div className="absolute top-0 left-0 w-full p-4 pointer-events-none flex justify-between items-start z-20 safe-area-top">
      ...
      <div className="flex flex-col gap-3 pointer-events-auto">
        <button 
            ...
            className="w-10 h-10 rounded-xl bg-slate-900/90 border border-slate-700 flex items-center justify-center text-xl shadow-lg active:scale-95 transition-transform hover:scale-105"
        >
            👤
        </button>
      ...
      <div className="flex flex-col items-end gap-3 pointer-events-auto">
        ...
        <button 
            ...
            className="flex items-center gap-3 bg-slate-900/90 backdrop-blur-xl pl-4 pr-2 py-2 rounded-2xl shadow-xl border border-slate-700 active:scale-95 transition-transform group hover:scale-105"
        >
           <div className="flex flex-col items-end mr-1">
             ...
             <span className="text-xs font-black text-slate-100 leading-none drop-shadow-sm">{formatNumber(state.totalXpEarned)} / {formatNumber(nextThreshold)} XP</span>
           </div>
